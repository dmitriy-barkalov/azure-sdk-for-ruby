...
module Azure
  module Models
    ...
    # Model object.
    #
    class StorageAccountListResponse
      ...
      def self.serialize_object(object)
        ...
        if (serialized_property)
          ...
          serialized_property.each do |element|
            if (element)
              element = Azure::Models::StorageAccount.serialize_object(element)
            end
            serializedArray.push(element);
          end
          serialized_property = serializedArray;
        end
        output_object['value'] = serialized_property

        serialized_property = object.next_link
        output_object['nextLink'] = serialized_property
        output_object
      end
      ...
      # @return [StorageAccountListResponse] Deserialized object.
      #
      def self.deserialize_object(object)
        return if object.nil?
        output_object = StorageAccountListResponse.new
        ...
        if (deserialized_property)
          ...
          deserialized_property.each do |element1|
            if (element1)
              element1 = Azure::Models::StorageAccount.deserialize_object(element1)
            end
