...
module Azure
  module Models
    ...
    # Model object.
    #
    class StorageAccountPropertiesCreateParametersJson
      ...
      # @return [StorageAccountPropertiesCreateParametersJson] Deserialized
      # object.
      #
      def self.deserialize_object(object)
        return if object.nil?
        output_object = StorageAccountPropertiesCreateParametersJson.new
